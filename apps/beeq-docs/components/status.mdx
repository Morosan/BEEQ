...
The status pattern is made up of a leading visual symbol and a short text label. Together they communicate state quickly and keep the message easy to scan in dense layouts such as tables, cards, and lists.

| Part | Element | Description |
|---|---|---|
| **1** | Icon | The leading visual symbol that reinforces the status meaning |
| **2** | Header | The short visible text that communicates the current state or condition |
...
| Slot | Description |
|---|---|
| `default` | The visible text label content for the status |
