...
<Frame className="px-4 py-4" caption="Avatar component overview">
  <div className="flex flex-wrap items-center gap-4">
    ...
    <bq-avatar
      ...
      size="medium"
    ></bq-avatar>
    <bq-avatar label="BEEQ team notifications" initials="BQ" shape="square" size="large">
      <bq-badge slot="badge" text-color="#fff">3</bq-badge>
    </bq-avatar>
  </div>
</Frame>

Avatars help people identify users, teams, or entities at a glance. Use them in places where identity matters, such as lists, comments, ownership indicators, and profile surfaces.
